<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="CSAT_.Pages.Home" MasterPageFile="~/MasterPage.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <img id="Home_img1" runat="server" src="~/Image/Home_img1.jpg" class="imgLeft" />
    <h3>Title 1</h3>
    ...
    <img id="Home_img2" runat="server" src="~/Image/Home_img2.jpg" class="imgRight" />
    <h3>Title 2</h3>
    <p>Write Something</p>
</asp:Content>